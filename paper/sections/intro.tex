...
\\
\begin{tabular}{ll}
  $H_0$ \ : & \begin{tabular}{@{}l@{}}\emph{Cultural states can not be infered from}\\\emph{population reading activty.}\end{tabular} \\
            & \\
  $H_A$ \ : & \begin{tabular}{@{}l@{}}\emph{Cultural states can be infered from}\\\emph{population reading activty.}\end{tabular}
\end{tabular}
